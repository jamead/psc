...
set_property PACKAGE_PIN C1 [get_ports {misc_adc_rst}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_rst}]
set_property PACKAGE_PIN D1 [get_ports {misc_adc_cnv}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_cnv}]
set_property PACKAGE_PIN B4 [get_ports {misc_adc_sck}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_sck}]
set_property PACKAGE_PIN B3 [get_ports {misc_adc_fs}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_fs}]
set_property PACKAGE_PIN D3 [get_ports {misc_adc_busy[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_busy[0]}]
set_property PACKAGE_PIN C4 [get_ports {misc_adc_busy[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_busy[1]}]
set_property PACKAGE_PIN D5 [get_ports {misc_adc_busy[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_busy[2]}]
set_property PACKAGE_PIN A1 [get_ports {misc_adc_sdo[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_sdo[0]}]
set_property PACKAGE_PIN A2 [get_ports {misc_adc_sdo[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_sdo[1]}]
set_property PACKAGE_PIN C3 [get_ports {misc_adc_sdo[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {misc_adc_sdo[2]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {rom[10]}]
