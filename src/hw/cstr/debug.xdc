...
connect_debug_port u_ila_0/probe7 [get_nets [list {write_dacs/dac_cntrl[ps1][gain][0]} {write_dacs/dac_cntrl[ps1][gain][1]} {write_dacs/dac_cntrl[ps1][gain][2]} {write_dacs/dac_cntrl[ps1][gain][3]} {write_dacs/dac_cntrl[ps1][gain][4]} {write_dacs/dac_cntrl[ps1][gain][5]} {write_dacs/dac_cntrl[ps1][gain][6]} {write_dacs/dac_cntrl[ps1][gain][7]} {write_dacs/dac_cntrl[ps1][gain][8]} {write_dacs/dac_cntrl[ps1][gain][9]} {write_dacs/dac_cntrl[ps1][gain][10]} {write_dacs/dac_cntrl[ps1][gain][11]} {write_dacs/dac_cntrl[ps1][gain][12]} {write_dacs/dac_cntrl[ps1][gain][13]} {write_dacs/dac_cntrl[ps1][gain][14]} {write_dacs/dac_cntrl[ps1][gain][15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 20 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list {write_dacs/dac_cntrl[ps1][dpram_data][0]} {write_dacs/dac_cntrl[ps1][dpram_data][1]} {write_dacs/dac_cntrl[ps1][dpram_data][2]} {write_dacs/dac_cntrl[ps1][dpram_data][3]} {write_dacs/dac_cntrl[ps1][dpram_data][4]} {write_dacs/dac_cntrl[ps1][dpram_data][5]} {write_dacs/dac_cntrl[ps1][dpram_data][6]} {write_dacs/dac_cntrl[ps1][dpram_data][7]} {write_dacs/dac_cntrl[ps1][dpram_data][8]} {write_dacs/dac_cntrl[ps1][dpram_data][9]} {write_dacs/dac_cntrl[ps1][dpram_data][10]} {write_dacs/dac_cntrl[ps1][dpram_data][11]} {write_dacs/dac_cntrl[ps1][dpram_data][12]} {write_dacs/dac_cntrl[ps1][dpram_data][13]} {write_dacs/dac_cntrl[ps1][dpram_data][14]} {write_dacs/dac_cntrl[ps1][dpram_data][15]} {write_dacs/dac_cntrl[ps1][dpram_data][16]} {write_dacs/dac_cntrl[ps1][dpram_data][17]} {write_dacs/dac_cntrl[ps1][dpram_data][18]} {write_dacs/dac_cntrl[ps1][dpram_data][19]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 16 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list {write_dacs/dac_cntrl[ps1][dpram_addr][0]} {write_dacs/dac_cntrl[ps1][dpram_addr][1]} {write_dacs/dac_cntrl[ps1][dpram_addr][2]} {write_dacs/dac_cntrl[ps1][dpram_addr][3]} {write_dacs/dac_cntrl[ps1][dpram_addr][4]} {write_dacs/dac_cntrl[ps1][dpram_addr][5]} {write_dacs/dac_cntrl[ps1][dpram_addr][6]} {write_dacs/dac_cntrl[ps1][dpram_addr][7]} {write_dacs/dac_cntrl[ps1][dpram_addr][8]} {write_dacs/dac_cntrl[ps1][dpram_addr][9]} {write_dacs/dac_cntrl[ps1][dpram_addr][10]} {write_dacs/dac_cntrl[ps1][dpram_addr][11]} {write_dacs/dac_cntrl[ps1][dpram_addr][12]} {write_dacs/dac_cntrl[ps1][dpram_addr][13]} {write_dacs/dac_cntrl[ps1][dpram_addr][14]} {write_dacs/dac_cntrl[ps1][dpram_addr][15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe10]
set_property port_width 8 [get_debug_ports u_ila_0/probe10]
connect_debug_port u_ila_0/probe10 [get_nets [list {write_dacs/dac_cntrl[ps1][cntrl][0]} {write_dacs/dac_cntrl[ps1][cntrl][1]} {write_dacs/dac_cntrl[ps1][cntrl][2]} {write_dacs/dac_cntrl[ps1][cntrl][3]} {write_dacs/dac_cntrl[ps1][cntrl][4]} {write_dacs/dac_cntrl[ps1][cntrl][5]} {write_dacs/dac_cntrl[ps1][cntrl][6]} {write_dacs/dac_cntrl[ps1][cntrl][7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe11]
set_property port_width 1 [get_debug_ports u_ila_0/probe11]
connect_debug_port u_ila_0/probe11 [get_nets [list write_dacs/dac_rden]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe12]
set_property port_width 1 [get_debug_ports u_ila_0/probe12]
connect_debug_port u_ila_0/probe12 [get_nets [list write_dacs/dac_start]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe13]
set_property port_width 1 [get_debug_ports u_ila_0/probe13]
connect_debug_port u_ila_0/probe13 [get_nets [list tenkhz_trig]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe14]
set_property port_width 1 [get_debug_ports u_ila_0/probe14]
connect_debug_port u_ila_0/probe14 [get_nets [list {write_dacs/dac_cntrl[ps1][jump]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe15]
set_property port_width 1 [get_debug_ports u_ila_0/probe15]
connect_debug_port u_ila_0/probe15 [get_nets [list {write_dacs/dac_cntrl[ps1][load]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe16]
set_property port_width 1 [get_debug_ports u_ila_0/probe16]
connect_debug_port u_ila_0/probe16 [get_nets [list {write_dacs/dac_cntrl[ps1][dpram_we]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe17]
set_property port_width 1 [get_debug_ports u_ila_0/probe17]
connect_debug_port u_ila_0/probe17 [get_nets [list {write_dacs/dac_cntrl[ps1][reset]}]]
