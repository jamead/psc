...
set_clock_groups -name plclk_fofbclk2 -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks -of_objects [get_pins fofb/phy_sfp0_rx/U0/core_clocking_i/mmcm_adv_inst/CLKOUT0]]
